...
python $INP_DIR/hivdrm_modified_rd.py \
--barcodes $INP_DIR/barcodes.csv \
--ref $INP_DIR/reference.fasta \
--threads 10 \
$INP_DIR/reads_R1.fq.gz $CODE_DIR/synthetic_546nt_data/synthetic_simEF_v15/reads_R2.fq.gz --outdir $OUT_DIR/outputfolder
